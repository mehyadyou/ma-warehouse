...
/// ترتیب صف بارگیری — آرایهٔ مرتب شناسهٔ باربری‌ها (بالا = دورترین = اولین بار،
/// پایین = نزدیک‌ترین = آخرین بار). سمت سرور اولویت‌ها (priority) بازچینی می‌شوند
/// تا برنامهٔ بارگیری راننده همان ترتیب را بگیرد
