  ...
  Future<void> _generate() async {
    ...
    try {
      ...
      final result = await ref
          .read(wkApiProvider)
          .getLoadingPlan(items, _strategy);
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              _StrategyChip(
                label: 'FIFO',
                subtitle: 'قدیمی‌ترها اول',
                selected: _strategy == 'FIFO',
                onTap: () => setState(() => _strategy = 'FIFO'),
              ),
              const SizedBox(width: 8),
              _StrategyChip(
                label: 'LIFO',
                subtitle: 'جدیدترها اول',
                selected: _strategy == 'LIFO',
            ...
            itemBuilder: (_, i) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: isInd ? _orange.withOpacity(0.3) : _border,
                  ),
                ),
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        isInd
                            ? 'تکی'
                            : '${item.capacityPerBox} ${item.unit ?? 'عدد'}',
                        style: TextStyle(
                          color: isInd ? _orange : _green,
                          fontSize: 11,
                          fontWeight: FontWeight.w600,
                        ),
                      ),
        ...
        child: Column(
          children: [
            ...
            Text(
              subtitle,
              style: TextStyle(
                color: selected ? _green.withOpacity(0.7) : Colors.white38,
                fontSize: 10,
              ),
            ),
          ],
...
class _Btn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      child: Icon(
        icon,
        color: enabled ? _green : Colors.white.withOpacity(0.2),
        size: 16,
      ),
    ),
  );
